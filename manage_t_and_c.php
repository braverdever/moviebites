...
{    
	...
	{            
		...
		'app_version'  =>  $_POST['app_version'],   
		 ...
		 'stipe_server_key'  =>  $_POST['stipe_server_key'],
		 'stipe_server_key'  =>  $_POST['stipe_server_key'],
...
{    
	...
	$data = array('stipe_server_key'  =>  addslashes($_POST['stipe_server_key']));      
	$settings_edit=Update('tbl_settings', $data, "WHERE id = '1'");
	
	$data = array('stipe_publish_key'  =>  addslashes($_POST['stipe_publish_key']));      
	$settings_edit=Update('tbl_settings', $data, "WHERE id = '1'");
								...
								<div class="col-md-12">
									<div class="m-portlet__head">
										<div class="m-portlet__head-tools">
											<ul class="nav nav-tabs m-tabs m-tabs-line   m-tabs-line--left m-tabs-line--primary" role="tablist">
												<li class="nav-item m-tabs__item active"> <a class="nav-link m-tabs__link" data-toggle="tab" href="#app_settings_tab_4" role="tab">Terms of Service</a> </li>
												<li class="nav-item m-tabs__item"> <a class="nav-link m-tabs__link" data-toggle="tab" href="#app_settings_tab_5" role="tab">Privacy Policy</a> </li>
												<li class="nav-item m-tabs__item"> <a class="nav-link m-tabs__link" data-toggle="tab" href="#app_settings_tab_6" role="tab">Other</a> </li>
									...
									<div class="tab-content">
										<div class="tab-pane active" id="app_settings_tab_4">
											<form class="form-horizontal" action="manage_t_and_c.php" method="post" enctype="multipart/form-data">
												<div class="panel-body">
													...
													<div class="form-group d-none">
														...
														<div class="col-lg-9">
															<textarea name="app_privacy_policy" id="app_privacy_policy__" rows="5" cols="5">
										...
										<div class="tab-pane" id="app_settings_tab_6">
											<form class="form-horizontal" action="manage_t_and_c.php" method="post" enctype="multipart/form-data">
												<div class="panel-body">
													<div class="form-group">
														<label class="col-lg-3 control-label">Stipe Publish Key :-</label>
														<div class="col-lg-9">
															<input type="text" name="stipe_publish_key" id="" value="<?php echo $settings_row['stipe_publish_key'];?>" class="form-control">
																
														
														</div>
													</div>
													<div class="form-group ">
														<label class="col-lg-3 control-label"> Stipe Server Key :-</label>
														<div class="col-lg-9">
															<input type="text"  name="stipe_server_key" id="stipe_server_key" value="<?php echo $settings_row['stipe_server_key'];?>" class="form-control">
														</div>
													</div>
													<div class="text-right">
														<button type="submit" name="app_terms_con" class="btn btn-primary"> Save changes<i class="icon-arrow-right14 position-right"></i> </button>
