...
$qry="SELECT * FROM tbl_notification where id='".$_GET['cat_id']."'";
...
if(isset($_POST['submit']) and isset($_POST['cat_id']))
{
    ...
    $category_edit=Update('tbl_notification', $data, "WHERE id = '".$_POST['cat_id']."'");
    

    $_SESSION['msg']="11"; 
    header( "Location:add_notification.php?cat_id=".$_POST['cat_id']);
    exit;
  }
