...
if(isset($_POST['submit']) and isset($_GET['add']))
{
    ...
    $tpath1='images/currentaffair/'.$image;        
    ...
    $qry = Insert('current_affers',$data);  

    $_SESSION['msg']="10";
    header( "Location:manage_current_affair.php");
    exit; 
}
...
$qry="SELECT * FROM current_affers where id='".$_GET['cat_id']."'";
...
if(isset($_POST['submit']) and isset($_POST['cat_id']))
{
	...
	{    
        ...
        $img_res=mysqli_query($mysqli,'SELECT * FROM current_affers WHERE id='.$_GET['cat_id'].'');

        $img_res_row=mysqli_fetch_assoc($img_res);

          if($img_res_row['image']!="")
			{
                unlink('images/currentaffair/'.$img_res_row['image']);
			}
          ...
          $category_edit=Update('current_affers', $data, "WHERE id = '".$_POST['cat_id']."'");
    }
    else
    {
    ...
    $_SESSION['msg']="11"; 
    header( "Location:add_current_affair.php?cat_id=".$_POST['cat_id']);
    exit;
  }
}
if(isset($_GET['cat_id']))
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Add</span> - Current Affair</h4>
						</div>

						<div class="heading-elements">
							<div class="heading-btn-group">
								<a href="manage_current_affair.php" class="btn btn-link btn-float has-text"><i class="icon-backward text-primary"></i><span>Back</span></a>
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" action="" name="addeditcategory" method="post" enctype="multipart/form-data">
							...
							<fieldset class="content-group">
								<legend class="text-bold">Current Affair Detail</legend>

								<div class="form-group">
									<label class="control-label col-lg-2">Current Affair Title </label>
									<div class="col-lg-10">
								...
								<div class="form-group">
									<label class="control-label col-lg-2">Current Affair Description </label>
									<div class="col-lg-10">
								...
								<div class="form-group">
									<label class="control-label col-lg-2">Current Affair Date </label>
									<div class="col-lg-10">
								...
								<div class="form-group">
									<label class="control-label col-lg-2">Current Affair Image </label>
									<div class="col-lg-10">							
											...
											<div class="media-left">
												<div class="media-body">
												   ...
												   <?php if(isset($_GET['cat_id']) and $row['image']!="") {?>
													<img src="images/currentaffair/<?php echo $row['image'];?>" style="width: 75px; height: 75px;" class="img-rounded" alt="">
													<?php } else{?>
