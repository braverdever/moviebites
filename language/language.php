<?php
	  ...
	  $client_lang['16'] = "Notification successfully send  ...";
	  $client_lang['17'] = "This is demo version...";
	  $client_lang['18'] = "Phone number is available in our database please use in other Phone number..";
	  $client_lang['19'] = "Phone number is available in our database you are not used this Phone number..";
